        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/public/sections").hasAuthority("ROLE_ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/public/sections/**").hasAuthority("ROLE_ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/public/sections/**").hasAuthority("ROLE_ADMIN")
